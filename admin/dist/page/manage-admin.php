...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    <div class="app-wrapper">
        ...
        <!-- the body star here -->
        <main class="app-main">
            <?php foreach (['addadmin', 'deletemsg', 'updatemsg'] as $key) :
            ...
            <div class="app-content-header">
                ...
                <div class="container-fluid">
                    ...
                    <!--end::Row-->
                    <a href="Add-admin.php" class="btn btn-primary mb-4">Add New Admin</a>
                </div>
                <!--end::Container-->
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#myDropdown").on("change", function() {
                limit = $(this).val();
                loadadmintable(currentPage, limit);
            });
            let currentPage = 1;
