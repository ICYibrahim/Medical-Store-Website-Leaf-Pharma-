...
$result = fetchtablewithlimit($limit, $offset, 'tbl_products');
if ($result === false) {
...
if (mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        $output .= '<td>
            <a href="update-products.php?id=' . $id . '&product_image=' . urlencode($product_image) . '&source_from=manage-product.php" class="btn btn-success m-md-2">
...
$total_result = fetchtable('tbl_products');
